...
using static XebecPortal.UI.Shared.Home.Models.JobPortalModels;

namespace XebecPortal.UI.Shared.Home
{
    public partial class JobPortal
    {
        ...
        public async Task SaveAnswers()
        {
            ...
            await httpClient.PostJsonAsync("https://xebecapi.azurewebsites.net/api/CandidateRecommender", candidateRecommender, new AuthenticationHeaderValue("Bearer", token));
